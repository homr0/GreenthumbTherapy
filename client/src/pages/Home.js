  ...
  render() {
    return (
      <Container>
        ...
        <Row id="planter-box">
          <Col size="s12 plant-box">
            <h2 className="center-align">
              <a href="/questionnaire" className="teal-text text-darken-2">Plant Matcher</a>
            </h2>

            <p className="center-align">Don't know where to start? Take our quiz to find the plant that is right for you!</p>
          </Col>

          <Col size="s6 plant-box">
            <h2>
          ...
          <Col size="s6 plant-box">
            ...
            <p className="right-align">Already a member of Greenthumb Therapy? Manage your plants, whether you love them or can't stand them.</p>
          </Col>
        </Row>
      </Container>
    );
